...
namespace Greenshot.DotNetCore3.CropDemo
{
    ...
    public sealed partial class CaptureForm : AnimatingForm
    {
        ...
        public CaptureForm(ICoreConfiguration coreConfiguration, ICapture capture, IList<IInteropWindow> windows)
        {
        ...
        protected override void Animate()
        {
            ...
            foreach (var window in _windows ?? Enumerable.Empty<IInteropWindow>())
            {
        ...
        private void DrawZoom(Graphics graphics, NativeRect sourceRectangle, NativeRect destinationRectangle)
        {
            ...
            using (var path = new GraphicsPath())
            {
                ...
                if (!_isZoomerTransparent)
                {
                    graphics.FillRectangle(Brushes.Black, destinationRectangle);
