...
namespace Greenshot.Addons.Core
{
    ...
    ///     Core configuration.
    /// </summary>
    public interface ICoreConfiguration : ICaptureConfiguration, INotifyPropertyChanged, IWriteProtectProperties, IDefaultValue, ITagging, ITransactionalProperties
    {
