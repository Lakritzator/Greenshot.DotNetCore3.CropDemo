...
using Greenshot.DotNetCore3.CropDemo;
using Greenshot.Gfx;
...
namespace Greenshot.Addons.Core
{
    ...
    public static class WindowCapture
    {
        ...
        private static readonly ICoreConfiguration Configuration = CoreConfiguration.Instance;
        ...
        public static ICapture CaptureRectangle(ICapture capture, NativeRect captureBounds)
        {
            ...
            Bitmap capturedBitmap = CaptureRectangle(captureBounds);
